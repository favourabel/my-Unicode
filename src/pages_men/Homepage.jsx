...
/* ==========================================
   ANIMATED SECTION WRAPPER — REPEATS EVERY TIME
   ========================================== */
...
/* ==========================================
   ANIMATED COUNTER — REPEATS EVERY TIME
   ========================================== */
const AnimatedCounter = ({ end, suffix = "", label, sub, icon, delay = 0 }) => {
  ...
  useEffect(() => {
    if (isInView) {
      ...
      // Reset count when out of view so it animates again
...
/* ==========================================
   ...
   ========================================== */
const testimonials = [
  { name: "Chioma Eze", role: "Computer Science, Class of 2023", quote: "Unicode University transformed my career. The faculty's dedication and world-class facilities gave me the confidence to land my dream job at a Fortune 500 company.", avatar: "CE" },
  { name: "David Okonkwo", role: "Economics, Class of 2022", quote: "The rigorous academic environment and supportive community at Unicode prepared me for the real world. I'm now pursuing my Master's at Oxford.", avatar: "DO" },
  { name: "Amara Nwosu", role: "Nursing, Class of 2024", quote: "From day one, Unicode felt like home. The clinical training and mentorship I received were exceptional. I'm proud to be an alumnus.", avatar: "AN" },
  { name: "Tunde Bakare", role: "Data Analytics, Class of 2023", quote: "The innovative curriculum and hands-on projects at Unicode gave me a competitive edge. I now lead a data team at a top tech firm.", avatar: "TB" },
];
  ...
  return (
    <div className="font-sans text-gray-800 bg-[#fafafa] overflow-x-hidden scroll-smooth">
      ...
      <div ref={heroRef} className="relative min-h-screen flex flex-col w-full overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-[#020817]/90 via-[#07162d]/75 to-[#020817]/95"></div>
        ...
        <motion.div className="relative z-10 flex-grow flex flex-col justify-center max-w-7xl mx-auto w-full px-5 sm:px-8 lg:px-16 pb-24 pt-28 md:pt-20" style={{ opacity: heroOpacity }}>
          ...
          <motion.p custom={3} variants={heroText} initial="hidden" animate="visible"
        ...
        <motion.div custom={4} variants={heroText} initial="hidden" animate="visible" className="flex flex-col sm:flex-row gap-4 mb-[60px]">
  <motion.button 
  ...
  <motion.button 
    ...
    <span className="flex items-center gap-2">
      ...
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
          ...
          <motion.div className="absolute bottom-10 left-1/2 -translate-x-1/2 flex-col items-center gap-3 hidden md:flex"
            initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 2 }}>
            <span className="text-white/30 text-[10px] tracking-[0.3em] uppercase font-medium">Scroll</span>
            <motion.div className="w-[2px] h-14 bg-gradient-to-b from-yellow-400/80 to-transparent rounded-full"
      ...
      {/* ==========================================
          ABOUT SECTION — REPEATS
          ========================================== */}
      <AnimatedSection id="About" className="relative py-20 md:py-32 overflow-hidden">
        <div className="absolute -top-40 -right-40 w-[600px] h-[600px] bg-yellow-400/[0.03] rounded-full blur-[120px]"></div>

        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center'>

            <motion.div variants={slideInLeft} className="relative group order-2 lg:order-1">
              <motion.div className="absolute -inset-4 bg-gradient-to-br from-yellow-400/15 via-amber-400/10 to-orange-400/15 rounded-3xl transform rotate-3"
                whileHover={{ rotate: 2 }} transition={{ duration: 0.7 }} />
              <div className="absolute -inset-4 bg-gradient-to-br from-yellow-400/5 to-amber-400/5 rounded-3xl transform rotate-3 scale-105 blur-2xl"></div>
              <motion.img src={two} alt="About Unicode"
              ...
              <motion.div className="absolute -bottom-6 -right-4 bg-white rounded-2xl shadow-2xl p-4 sm:p-5"
              ...
              <div className="absolute -top-4 -left-4 w-20 h-20 border-[3px] border-yellow-400/20 rounded-2xl"></div>
            </motion.div>
            ...
            <motion.div variants={slideInRight} className="space-y-6 lg:space-y-8 order-1 lg:order-2">
              ...
              <div className="w-14 h-[3px] bg-gradient-to-r from-yellow-400 to-amber-500 rounded-full"></div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                {[
                  { title: "Our Vision", sub: "Leading global institution", color: "from-yellow-400 to-amber-500", icon: "M15 12a3 3 0 11-6 0 3 3 0 016 0zM2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" },
                  { title: "Our Value", sub: "Excellence & Integrity", color: "from-blue-500 to-indigo-600", icon: "M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z" },
                ].map((card, i) => (
                  <motion.div key={i} whileHover={{ y: -4, boxShadow: "0 20px 40px -10px rgba(0,0,0,0.1)" }}
      ...
      {/* ==========================================
          MISSION SECTION — REPEATS
          ========================================== */}
      <AnimatedSection id="Mission" className='relative py-24 sm:py-32 md:py-40 px-4 sm:px-6 lg:px-8 overflow-hidden'>
        <div className="absolute inset-0 bg-gradient-to-br from-[#020817] via-[#0c1a33] to-[#020817]"></div>
        <div className="absolute inset-0" style={{backgroundImage:'radial-gradient(circle at 25% 35%, rgba(201,168,76,0.06) 0%, transparent 50%), radial-gradient(circle at 75% 65%, rgba(99,102,241,0.04) 0%, transparent 50%)'}}></div>
        ...
        <div className="relative max-w-5xl mx-auto text-center space-y-8 md:space-y-12">
          <motion.div variants={fadeUp} className="flex items-center justify-center gap-3">
            <span className="w-8 h-[1.5px] bg-yellow-400/40 rounded-full"></span>
          ...
          <motion.div variants={fadeUp} className="flex items-center justify-center gap-3">
            <div className="w-12 h-[2px] bg-gradient-to-r from-transparent to-yellow-400/60 rounded-full"></div>
            <div className="w-3 h-3 bg-yellow-400 rounded-full rotate-45"></div>
            <div className="w-12 h-[2px] bg-gradient-to-l from-transparent to-yellow-400/60 rounded-full"></div>
          </motion.div>
      ...
      {/* ==========================================
          TIMELINE SECTION — REPEATS
          ========================================== */}
      <AnimatedSection className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28 overflow-hidden" id= "History">
        <div className="text-center mb-14 md:mb-20">
          <motion.div variants={fadeUp} className="flex items-center justify-center gap-3 mb-4">
            <span className="w-10 h-[2px] bg-yellow-500/60 rounded-full"></span>
        ...
        <div className="relative">
          <div className="absolute left-6 sm:left-1/2 sm:-translate-x-[1px] top-0 bottom-0 w-[2px] timeline-line hidden sm:block"></div>
          <div className="absolute left-6 top-0 bottom-0 w-[2px] timeline-line sm:hidden"></div>
      ...
      {/* ==========================================
          STUDENT ACHIEVEMENTS — REPEATS
          ========================================== */}
      <AnimatedSection className="relative py-20 md:py-28 overflow-hidden" id = "Achievements">
        <div className="absolute inset-0 bg-gradient-to-b from-[#fef9f0] to-white"></div>
      ...
      {/* ==========================================
          ...
          ========================================== */}
      <AnimatedSection className="relative py-20 md:py-28 overflow-hidden" id = "Testimonials">
        <div className="absolute inset-0 bg-gradient-to-br from-[#020817] via-[#07162d] to-[#020817]"></div>
        <div className="absolute inset-0" style={{backgroundImage:'radial-gradient(circle at 30% 50%, rgba(201,168,76,0.06) 0%, transparent 50%)'}}></div>

        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14 md:mb-20">
            <motion.div variants={fadeUp} className="flex items-center justify-center gap-3 mb-4">
              <span className="w-10 h-[2px] bg-yellow-400/40 rounded-full"></span>
            ...
            <div className="flex justify-center gap-3 mt-8">
              {testimonials.map((_, i) => (
                <button key={i} onClick={() => setActiveTestimonial(i)}
                  className={`w-3 h-3 rounded-full transition-all duration-300 ${i === activeTestimonial ? 'bg-yellow-400 w-8' : 'bg-white/20 hover:bg-white/40'}`} />
              ))}
            </div>
      ...
      {/* ==========================================
          EVENT COUNTDOWN — REPEATS
          ========================================== */}
      <AnimatedSection className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28" id = "Events">
        <motion.div variants={scaleUp}
          className="relative bg-gradient-to-br from-[#07162d] via-[#0a1d38] to-[#07162d] rounded-3xl overflow-hidden">
          <div className="absolute inset-0" style={{backgroundImage:'radial-gradient(circle at 50% 50%, rgba(201,168,76,0.08) 0%, transparent 50%)'}}></div>
            ...
            <div className="flex justify-center gap-3 sm:gap-5 md:gap-8 mb-10">
              {[
                ...
                <div key={i} className="text-center">
                  <motion.div className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 glass rounded-2xl flex items-center justify-center mb-2 sm:mb-3"
                  ...
                  <span className="text-gray-400 text-[10px] sm:text-xs font-semibold tracking-wider uppercase">{item.label}</span>
                </div>
              ))}
            </div>
      ...
      {/* ==========================================
          TERMS SECTION — REPEATS
          ========================================== */}
      <AnimatedSection id="Rules" className="relative py-24 sm:py-32 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-[#07162d] via-[#0a1d38] to-[#07162d]"></div>
        <div className="absolute inset-0" style={{backgroundImage:'radial-gradient(circle at 50% 0%, rgba(201,168,76,0.06) 0%, transparent 40%)'}}></div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.div variants={staggerContainer} className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-10">
            {[
              { title: "Terms & Conditions", desc: "By using this website, you agree to follow all rules and guidelines. All content is for educational purposes. Users must not misuse, damage, or interfere with the website. We reserve the right to update content at any time.", icon: "M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" },
              { title: "Privacy Policy", desc: "We respect your privacy. Any information collected is used only for communication and school purposes. We do not sell or share your data with third parties except when required by law.", icon: "M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" },
            ].map((card, i) => (
              <motion.div key={i} variants={staggerItem}
                ...
                <div className="flex items-start gap-5 mb-6">
                  <div className="w-14 h-14 bg-yellow-400/10 border border-yellow-400/20 rounded-2xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 group-hover:bg-yellow-400/20 transition-all duration-500">
                    <svg className="w-7 h-7 text-yellow-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d={card.icon} /></svg>
                  </div>
                  <div>
      ...
      {/* ==========================================
          COURSES SECTION — REPEATS
          ========================================== */}
      <AnimatedSection id="Courses" className='relative py-24 sm:py-32 overflow-hidden'>
        <div className="absolute inset-0 bg-gradient-to-b from-[#fffcf5] via-[#fef8ee] to-[#fffcf5]"></div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {[
              ...
              <motion.div key={i} variants={staggerItem}
                ...
                <div className='p-6 sm:p-7 flex-grow flex flex-col'>
                  <h3 className='text-lg sm:text-xl font-bold text-[#07162d] mb-3 group-hover:text-yellow-600 transition-colors duration-300 font-serif'>{course.title}</h3>
                  ...
                  <div className="mt-5 pt-4 border-t border-gray-100 flex items-center justify-between">
                    ...
                    <div className="w-9 h-9 bg-yellow-50 rounded-xl flex items-center justify-center group-hover:bg-yellow-400 transition-colors duration-300">
                      <svg className="w-4 h-4 text-yellow-600 group-hover:text-white transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" /></svg>
                    </div>
                  </div>
                </div>
              </motion.div>
          ...
          <motion.div variants={fadeUp} className="text-center mt-14 sm:mt-16">
            <motion.button whileHover={{ scale: 1.03, boxShadow: "0 20px 40px -10px rgba(7,22,45,0.3)" }} whileTap={{ scale: 0.98 }}
      ...
      {/* ==========================================
          GALLERY SECTION — REPEATS
          ========================================== */}
      <AnimatedSection className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28 overflow-hidden"  id = "Gallery">
        <div className="text-center mb-14 md:mb-20">
          <motion.div variants={fadeUp} className="flex items-center justify-center gap-3 mb-4">
            <span className="w-10 h-[2px] bg-yellow-500/60 rounded-full"></span>
        ...
        <motion.div variants={staggerContainer} className="grid grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
          {galleryImages.map((item, i) => (
            <motion.div key={i} variants={staggerItem}
              ...
              <motion.img src={item.img} alt={item.caption}
                className="absolute inset-0 w-full h-full object-cover"
                whileHover={{ scale: 1.08 }} transition={{ duration: 0.7, ease: [0.16, 1, 0.3, 1] }} />
              <div className="absolute inset-0 bg-gradient-to-t from-[#07162d]/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-10"></div>
              <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6 translate-y-4 group-hover:translate-y-0 transition-transform duration-500 z-20">
                <p className="text-white font-bold text-sm sm:text-base opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-100">{item.caption}</p>
              </div>
            </motion.div>
          ))}
        </motion.div>
        ...
        <div className="marquee-track">
          {[...Array(2)].map((_, idx) => (
            <div key={idx} className="flex items-center gap-10 sm:gap-16 px-5 sm:px-8 whitespace-nowrap">
              {["Accredited Programs", "World-Class Faculty", "Modern Facilities", "Research Excellence", "Global Partnerships", "Student Success", "Innovation Hub", "Community Impact"].map((text, i) => (
                <span key={i} className="flex items-center gap-3 sm:gap-4 text-white/25 text-sm sm:text-base font-medium tracking-wider uppercase">
                  <span className="w-2 h-2 bg-yellow-400/40 rounded-full"></span>
                  {text}
                </span>
              ))}
            </div>
...
/* ==========================================
   EXTRACTED COMPONENTS — REPEAT ON SCROLL
   ========================================== */

// Leader Card — repeats animation on every scroll
  ...
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl shadow-xl">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-[#020817]/90 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
        ...
        <div className="absolute bottom-0 left-0 right-0 p-5 sm:p-6 translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
          <p className="text-yellow-400 text-xs sm:text-sm font-bold tracking-wider uppercase mb-1 opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-100">{leader.title}</p>
          <p className="text-white text-base sm:text-lg font-bold opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-200">{leader.name}</p>
        </div>
...
// Timeline Item — repeats animation on every scroll
const TimelineItem = ({ item, index }) => {
  ...
  return (
    <motion.div
      ref={ref}
      className={`relative flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-0 ${index % 2 === 0 ? 'sm:flex-row' : 'sm:flex-row-reverse'} sm:mb-16`}
      initial={{ opacity: 0, x: index % 2 === 0 ? -60 : 60 }}
      animate={isInView ? { opacity: 1, x: 0 } : { opacity: 0, x: index % 2 === 0 ? -60 : 60 }}
      transition={{ duration: 0.7, delay: 0.1, ease: [0.16, 1, 0.3, 1] }}
    >
      <div className={`pl-14 sm:pl-0 sm:w-[calc(50%-40px)] ${index % 2 === 0 ? 'sm:pr-12 sm:text-right' : 'sm:pl-12 sm:text-left'}`}>
        <motion.div
          className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100"
          whileHover={{ y: -4, boxShadow: "0 20px 40px -10px rgba(0,0,0,0.1)" }}
          transition={{ duration: 0.3 }}
        >
          <span className="inline-block font-serif text-2xl sm:text-3xl font-black gradient-text mb-2">{item.year}</span>
